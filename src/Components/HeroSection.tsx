      ...
      <section className="relative bg-[#0D1D3D] py-12 sm:py-16 lg:py-20 overflow-hidden min-h-125 sm:min-h-150">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-6 leading-tight">
            Bridging Africa&apos;s{" "}
            <span className="text-red-400">Research</span>
          ...
          <p className="text-base sm:text-lg text-white/80 max-w-3xl mx-auto mb-8 sm:mb-10 px-4">
            ...
            infrastructure designed to align local research with global
            discovery.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4">
            <a
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-[#2d3f5f] text-white rounded-lg hover:bg-[#3d4f6f] transition-colors text-sm sm:text-base
          cursor-pointer"
              href="#waitlist-form">
            ...
            <button
              className="w-full sm:w-auto px-6 py-3 text-white hover:text-white/80 transition-colors text-sm sm:text-base"
